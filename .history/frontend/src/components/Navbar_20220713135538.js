  ...
  return (
    <header className="flex space-x-4 items-center justify-between align-middle  p-4 bg-blue-400">
      <div className="text-center ">
        <img className="object-contain w-32" src={logo} alt="" />
      </div>
      <div class="flex items-center justify-center">
        <div class="input-group flex  items-stretch w-full  rounded">
          <input
            type="search"
            class="form-control  flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal   bg-clip-padding border border-solid border-blue-300 rounded transition ease-in-out m-0 focus:text-gray-900 focus:bg-white focus:border-blue-600 focus:outline-none opacity-25"
            placeholder="Search"
            aria-label="Search"
